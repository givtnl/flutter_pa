...
class CustomValueIndicatorShape extends RectangularSliderValueIndicatorShape {
...
class _RectangularSliderValueIndicatorPathPainter {
  ...
  static const double _bottomTipYOffset = 30; // Makes the value indicator go up
  ...
  void paint({
    ...
    final Offset boxCenter = Offset(horizontalShift, upperRect.height / 2 + 1); //+1 bc it doesn't look exactly in the middle otherwise
